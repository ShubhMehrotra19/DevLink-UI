...
function Cardfront_res({
  ...
  return (
    <div className=" select-none p-6 flex flex-col bg-[#F9F9F9] shadow-white/50 shadow-md h-[450px] w-[300px] rounded flex-grow mb-8 active:scale-95 hover:scale-[102%] transition-all duration-300 cursor-pointer ease-in-out">
